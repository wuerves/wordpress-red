...
function optionsframework_options()
{
    ...
    $options[] = array(
        'name' => '首屏广告图片',
        'id' => 'krsort_hm_img',
        'std' => get_template_directory_uri() . '/images/banner.png',
		'type' => 'upload'
	);
    ...
    $options[] = array(
        'name' => '首屏广告链接（格式：https://www.xxxx.com）',
        'id' => 'krsort_hm_tx2',
        'std' => '一款金融WordPress博客主题',
		'type' => 'text'
	);
