...
?>
        ...
        <tr>
            <td>
                ...
                <a  class="Home11"target="_blank" href="/sitemap.html">网站地图</a>
                &nbsp;|&nbsp;
                <a class="Home11" href="/lxwm">关于我们</a>
                &nbsp;|&nbsp;
                <a class="Home11"target="_blank" href="">建站超市</a>
                &nbsp;|&nbsp;
				
				 <a class="Home11"  href="/fk">在线定制</a>
				 &nbsp;|&nbsp;
				 <a class="Home11"  href="/23688.html">友情链接</a>
				 &nbsp;|&nbsp;
				<a class="Home11" target="_blank" href="">腾讯云优惠券</a>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-6 col-md-offset-3 footer-list text-center">
									...
									<p>Copyright <?php echo date('Y'); ?> <a href="<?php echo get_option('home'); ?>"><?php bloginfo('name'); ?></a>. All Rights Reserved.<br>备案 <a href="http://beian.miit.gov.cn/state/outPortal/loginPortal.action" target="_blank" rel="nofollow">鄂ICP备17015179号</a>  
