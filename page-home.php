...
<div class="qyb-login"><a href="" onclick="javascript:window.open('https://www.54u.net/lxwm', '_blank')" class="register">购买主题</a></div>
...
<div id="kratos-blog" class="kratos-page-default">
	<div class="container">
		<div class="row">
			...
			<?php query_posts('showposts=16&cat=' . kratos_option('krsort_hm_bk1') . '')?> 
...
<li class="tab-pane" id="ert_pane2-1"><div id="kratos-blog" class="kratos-page-default">
	...
	<div class="container">
		<div class="row">
			<?php query_posts('showposts=16&cat=' . kratos_option('krsort_hm_bk2') . '')?> 
			<?php while (have_posts()) : the_post(); ?>
			<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
				<div class="kratos-post ">
					<div class="kratos-post-image">
...
<li class="tab-pane" id="ert_pane2-2"><div id="kratos-blog" class="kratos-page-default">
	...
	<div class="container">
		<div class="row">
			<?php query_posts('showposts=16&cat=' . kratos_option('krsort_hm_bk3') . '')?> 
			<?php while (have_posts()) : the_post(); ?>
			<div class="col-md-3 col-sm-6 col-xs-6 col-xxs-12 ">
				<div class="kratos-post ">
					<div class="kratos-post-image">
