...
<div class="kratos-post-inner">
	<header class="kratos-entry-header clearfix">
		...
		<div class="kratos-post-meta">
			...
			<span>#respond"><i class="fa fa-commenting-o"></i> <?php comments_number('0', '1', '%'); ?>条评论</span>
			</span>
			<span class="pull-left">
			<span><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?>次阅读</span>
			<span><i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?>人点赞</span>
			</span>
		</div>
	</header>
...
<div class="kratos-entry-border-new clearfix">
	...
	<div class="kratos-post-meta-new">
		<span class="visible-lg visible-md visible-sm pull-left">
			...
			<a><i class="fa fa-commenting-o"></i> <?php comments_number('0', '1', '%'); ?>条评论</a>
		</span>
		<span class="pull-left">
			<a><i class="fa fa-eye"></i> <?php echo kratos_get_post_views(); ?>次阅读</span>
			<a><i class="fa fa-thumbs-o-up"></i> <?php if( get_post_meta($post->ID,'love',true) ){ echo get_post_meta($post->ID,'love',true); } else { echo '0'; }?>人点赞</a>
		</span>
